...
class LEMMA(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return question_encode, answer_encode, vgg, c3d


def collate_func(batch):
    question_encode_lst, answer_encode_lst, vgg_lst, c3d_lst = [], [], [], []
    question_length_lst = []
    for i, (question_encode, answer_encode, vgg, c3d) in enumerate(batch):
    ...
    return question_encode_lst, answer_encode_lst, vgg_lst, c3d_lst, question_length_lst
...
if __name__ == '__main__':
    ...
    for i, (question_encode, answer_encode, vgg, c3d, question_length_lst) in enumerate(dataloader):
