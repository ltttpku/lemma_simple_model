...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='tgif-qa', choices=['tgif-qa', 'msrvtt-qa', 'lemma-qa'], type=str)
    ...
    if args.dataset == 'tgif-qa':
        ...
        args.annotation_file = '/home/leiting/scratch/data/msrvtt/annotations/{}_qa.json'.format(args.mode)
        # check if data folder exists
        ...
        if not os.path.exists('data/{}'.format(args.dataset)):
            os.makedirs('data/{}'.format(args.dataset))
        lemma_qa.process_questions(args)
